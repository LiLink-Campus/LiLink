...
export const metadata: Metadata = {
  ...
  description: "人工登记、个人画像梳理、对应约会套餐与首次约会介绍安排。服务总价每人 ¥599，定金 ¥299、尾款 ¥300，目前暂未开放。",
};

const steps = [
  ["人工登记", "开放后支付 ¥299 定金，由运营登记你的基本情况与交友需求。"],
  ["刻画画像", "通过人工沟通梳理性格、兴趣与择偶期待，寻找符合需求的候选人。"],
  ["人工筛选和匹配", "根据个人画像与交友需求，由运营人工筛选候选人并进行匹配。"],
  ["双方确认", "找到满意的候选人，且双方都希望继续约会安排后，再支付 ¥300 尾款。"],
  ...
  return <main className={styles.page}>
    ...
    <section className={styles.plans} aria-label="服务方案">
      <article className={styles.plan}>
        ...
        <div className={styles.paymentSteps}><div><span>第一阶段 · 定金</span><strong>¥299</strong><p>服务开放后，登记并开始人工沟通、画像梳理。</p></div><div><span>第二阶段 · 尾款</span><strong>¥300</strong><p>找到满意候选人，且双方都希望跟进约会安排后支付。</p></div></div>
      </article>
    </section>
    ...
    <section className={`${faqStyles.section} ${styles.faqSection}`} aria-labelledby="activity-faq-title">
      ...
      <details name="activity-faq" className={faqStyles.item}><summary>¥299 定金和 ¥300 尾款分别什么时候支付？</summary><div className={faqStyles.answer}>服务开放后，先支付 ¥299 定金，开始人工登记与画像梳理。找到满意的候选人，且双方都希望跟进约会安排时，再支付 ¥300 尾款，总计 ¥599 / 人。</div></details>
    ...
    <div className={styles.mobileCta}><span>人工服务 ¥599 / 人<small>定金 ¥299 + 尾款 ¥300</small></span><WechatContact compact /></div>
  </main>;
}

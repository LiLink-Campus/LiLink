...
- Keep checks and captures scoped to affected states. Follow [visual verification](../../archive/2026-09-08-web-visual-verification.md) for commands; use the full smoke suite when the change warrants it.

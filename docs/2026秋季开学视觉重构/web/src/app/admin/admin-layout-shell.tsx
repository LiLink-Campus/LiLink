...
function AdminSidebar() {
  ...
  return (
    <aside className={cx(shellStyles, "admin-sidebar", mobileNavOpen && "is-mobile-nav-open")}>
      <div className={cx(shellStyles, "admin-sidebar-mobile-bar")}>
        ...
        >
          <span
            className={cx(adminBrandStyles, "glyph admin-brand-glyph admin-brand-glyph-compact")}
            aria-hidden="true"
          >
            <BrandIcon />
          </span>
      ...
      <Link
        ...
        aria-label="LiLink 后台首页"
      >
        <span className={cx(adminBrandStyles, "glyph admin-brand-glyph")} aria-hidden="true">
          <BrandIcon />
        </span>

...
export function HomeClient({
  ...
  return (
    ...
    >
      ...
      <HomeOverview counterpartName={counterpartDisplayName} name={initialUser.displayName ?? "同学"} agenda={agenda} hasCycle={Boolean(cycle)} optedIn={isOptedIn} canEdit={canEdit} eligible={questionnaireEligibleToOptIn} intent={intent} saving={saving} onAction={handleAgendaAction} />

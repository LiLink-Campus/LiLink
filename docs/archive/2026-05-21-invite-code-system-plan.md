...
> 来源提交：`11d778da292e67116a4caa1a5c760e56f8fc379c`；原文件：`docs/superpowers/plans/2026-05-21-invite-code-system.md`。
...
**Spec:** `docs/archive/2026-05-21-invite-code-system.md`（含 §15 codex 评审决议）。
